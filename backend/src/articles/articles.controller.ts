import { Controller, Get, Post, Put, Delete, Body, Param, ParseIntPipe, Query, Request } from '@nestjs/common';
...
export class ArticlesController {
  ...
  update(
    ...
    return this.articlesService.update(id, data, req.user.id, req.user.role);
  }
  ...
  rollbackToVersion(
    ...
    return this.articlesService.rollbackToVersion(id, versionNumber, req.user.id, req.user.role);
  }
