<template>
  <AdminLayout>
    <div class="article-edit-container">
        ...
        <template #header>
          <div class="card-header">
            ...
            <div class="header-actions">
              ...
              <el-button
                v-if="isAdmin && articleForm.status === 'PENDING_REVIEW'"
                type="success"
                @click="handleApprove"
                :loading="approving"
              >
              ...
              <el-button
                v-if="isAdmin && articleForm.status === 'PUBLISHED'"
                type="info"
                @click="handleArchive"
                :loading="archiving"
              >
            ...
            <div class="editor-wrapper">
              <div class="editor-toolbar">
                ...
                <el-button-group>
                  ...
                  <el-button
                    :type="
                      editor?.isActive('codeBlock') ? 'primary' : 'default'
                    "
      ...
      <el-dialog v-model="showVersionsDialog" title="历史版本" width="700px">
...
const handleRollback = async (row: any) => {
  ...
  try {
    ...
    await request.put(
      `/articles/${articleId.value}/rollback/${row.versionNumber}`,
    );
